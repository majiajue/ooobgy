 ...
 * 
 */
public class GenerateQueryBaseTable_Pref4j extends AbstractProcessor {
	...
	public static class TopMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException{
			StopWatch qbWatch = new LoggingStopWatch("Query Base");
...
/*---*/		StopWatch splitWatch = new LoggingStopWatch("Query Base --- Split");
...
/*---*/		splitWatch.stop();
			...
			StopWatch catIdWatch = new LoggingStopWatch("Query Base --- CatId");
			...
			StopWatch queryWatch = new LoggingStopWatch("Query Base --- Query");			
			...
			for (Utility.BehaviorData data : behaviorDatas) {
				try {
					StopWatch queryUniformWatch = new LoggingStopWatch("Query Base --- QueryUniform");					
					...
					queryUniformWatch.stop();
					
					StopWatch queryFlagWatch = new LoggingStopWatch("Query Base --- QueryFlag");
