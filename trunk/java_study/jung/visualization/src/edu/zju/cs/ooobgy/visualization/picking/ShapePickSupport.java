 ...
 *
 */
package edu.zju.cs.ooobgy.visualization.picking;
...
public class ShapePickSupport<V, E> implements GraphElementAccessor<V,E> {
    ...
    protected Collection<V> getFilteredVertices(Layout<V,E> layout) {
    	if(verticesAreFiltered()) {
    		Collection<V> unfiltered = (Collection<V>) layout.getGraph().getVertices();
    		...
    		return (Collection<V>) layout.getGraph().getVertices();
    	}
    }
