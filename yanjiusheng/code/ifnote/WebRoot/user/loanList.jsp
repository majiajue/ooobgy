...
<html> 
	<head>
		<title>JSP for loanListForm form</title>
    <style type="text/css">
<!--
td {
	font-size: 14px;
...
-->
	...
	<body>
		<html:form action="/loanList" styleId="loanListForm">
		<script language="javascript" type="text/javascript" src="/ifnote/util/dater/My97DatePicker/WdatePicker.js"></script>
			<p align="center"><img src="/ifnote/images/title_loan.png" width="464" height="131" alt="贷款记录管理"></p>
			<hr>
			  ...
			  <tr>
			    <td><table width="100%" border="0">
			      <tr>
			        ...
			        <td><img src="/ifnote/images/query.png" width="113" height="36" alt="查询" style="cursor:hand;" onClick="javascript:document.loanListForm.submit();"></td>
                    <td align="right"><img src="/ifnote/images/add_ico.jpg" width="113" height="36" alt="新增" style="cursor:hand;" onClick="window.location.href('/ifnote/inote/noteLoan.jsp')"></td>
		          </tr>
		        </table></td>
		      </tr>
			  <tr>
			    <td><table width="400" border="1" class="diantable">
		          ...
		          <bean:define id="inote_Loans" name="loanListForm" property="inote_Loans" type="java.util.List"></bean:define>			     
				...
				<td>
                    	...
                    	onClick="window.location.href('/ifnote/inote/noteLoan.jsp?nid=<bean:write name="inote" property="id"/>')"/>
                    </td>
                    <td>
		...
		<script language="javascript" type="text/javascript">
			function submitDel(nid){
				...
				if   (!conf)   return;
					...
					var link = '/ifnote/component/delok.jsp?type=loan&nid=' + nid;
