...
function generatetable(pagerRes) {
	...
	for ( var i = 0; i < infoList.length; i++) {
		...
		th1.innerHTML = id;
		th2.innerHTML = "<div align=\"center\"><img style=\"cursor:hand;\" onclick=\"viewNoticeAdmin("+id+")\" src=\"/examOnline/pager/pagerskin/eye.png\" width=\"20\" height=\"20\" alt=\"查看\">"+title+"</div>";
		th3.innerHTML = time;
...
function delNoticeAdmin(Did){
	var msg = "您真的确定要删除吗？\n\n请确认！";
	if (confirm(msg)==true){
		var url = "/examOnline/delNoticeAdmin.do?noticeId=" + Did;
		window.location.href(url);
		return true;
	}else{
		return false;
